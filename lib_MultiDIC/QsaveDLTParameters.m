...
%% function for asking the user for saving options for the DLT paramaters in STEP1.
% Including overwriting options
%
% INPUTS:
% * imagePaths: 1-by-NumberOfCameras cell array, containing in each
%   cell the path to the calibration images. The camera index is retrieved from the file name (_Ncam)
%
% OUTPUTS:
