function [] = anim8_DIC_images(ImPaths,ImSet)
% anim8_DIC_images
...
suptitle('Image set from camera pair for correlation. Press play to preview all images,press stop button and then press enter in the command window to continue');
