...
% Extract_Ncorr_results
%[Points,CorCoeffVec,F,CF] = extractNcorrResults(handles_ncorr,IM);

% function for Extracting the results from Ncorr and calculate correlated image points, correlation coefficients, faces and face colors
