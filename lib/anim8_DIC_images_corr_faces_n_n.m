...
% [] = anim8_DIC_images(IMset,DIC_2Dpair_results,CorCoeffDispMax);

% function for plotting the images chosen for stereo DIC (2 views) with the
...
% coefficients, faces..
% * optional: CorCoeffDispMax - maximal correlation coefficient to plot
% (effects the colorbar)
