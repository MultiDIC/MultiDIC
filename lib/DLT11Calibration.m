...
% L = DLT11Calibration(P2,P3)
% INPUT:
% P2 is a Nx2 matrix of N 2D image points
% P3 is a Nx3 matrix of N 3D world points
% The points must be corresponded (the indeces of the points have to match)
% OUTPUT:
% L is a vector with 11 numbers reoresenting the 11 DLT parameters
